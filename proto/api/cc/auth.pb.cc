...
void protobuf_AssignDesc_auth_2eproto() {
  ...
  StartTokenAuthReq_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      StartTokenAuthReq::default_instance_,
...
StartTokenAuthReq* StartTokenAuthReq::default_instance_ = NULL;
...
void AuthRsp::InitAsDefaultInstance() {
  _is_default_instance_ = true;
  user_ = const_cast< ::zproto::User*>(&::zproto::User::default_instance());
