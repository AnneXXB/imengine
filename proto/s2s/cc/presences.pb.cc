...
void protobuf_AssignDesc_presences_2eproto() {
  ...
  ZOnlineUser_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ZOnlineUser, _is_default_instance_));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      ZOnlineUser_descriptor_, &ZOnlineUser::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_presences_2eproto() {
  ...
  delete ZOnlineUser::default_instance_;
...
void protobuf_AddDesc_presences_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_presences_2eproto() {
  ...
  ZOnlineUser::default_instance_ = new ZOnlineUser();
  ...
  ZOnlineUser::default_instance_->InitAsDefaultInstance();
...
const ZUserID& ZUserID::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_presences_2eproto();
...
ZOnlineUser* ZOnlineUser::default_instance_ = NULL;
